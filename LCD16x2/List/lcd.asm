...
; 0000 0052 UCSRB=0x00;
	OUT  0xA,R30
; 0000 0053 
; 0000 0054 // Analog Comparator initialization
; 0000 0055 // Analog Comparator: Off
; 0000 0056 // Analog Comparator Input Capture by Timer/Counter 1: Off
; 0000 0057 ACSR=0x80;
	LDI  R30,LOW(128)
	OUT  0x8,R30
; 0000 0058 SFIOR=0x00;
	LDI  R30,LOW(0)
	OUT  0x30,R30
; 0000 0059 
; 0000 005A // ADC initialization
; 0000 005B // ADC disabled
; 0000 005C ADCSRA=0x00;
	OUT  0x6,R30
; 0000 005D 
; 0000 005E // SPI initialization
; 0000 005F // SPI disabled
; 0000 0060 SPCR=0x00;
	OUT  0xD,R30
; 0000 0061 
; 0000 0062 // TWI initialization
; 0000 0063 // TWI disabled
; 0000 0064 TWCR=0x00;
	OUT  0x36,R30
; 0000 0065 
; 0000 0066 // Alphanumeric LCD initialization
; 0000 0067 // Connections specified in the
; 0000 0068 // Project|Configure|C Compiler|Libraries|Alphanumeric LCD menu:
; 0000 0069 // RS - PORTB Bit 0
; 0000 006A // RD - PORTB Bit 1
; 0000 006B // EN - PORTB Bit 2
; 0000 006C // D4 - PORTB Bit 4
; 0000 006D // D5 - PORTB Bit 5
; 0000 006E // D6 - PORTB Bit 6
; 0000 006F // D7 - PORTB Bit 7
; 0000 0070 // Characters/line: 8
; 0000 0071 lcd_init(8);
	LDI  R30,LOW(8)
	ST   -Y,R30
	RCALL _lcd_init
; 0000 0072 
